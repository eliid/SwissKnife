...
public class SerializationUtil {
     ...
     * 
     * @param filename
     *            full path and file name, creates parent folders if need.
     * @param o
     *            object to be serialized
     * @param force
     *            overrides files if exists
     * 
    ...
    public static void serialize(String filename, Object o) throws NotSerializableException {
    ...
    public static <T extends Serializable> T deserialize(String filename, Class<T> classs) {
        ...
        if (new File(filename).exists()) {
            ...
            LOG.info("File not exists to unserialize: " + filename);
        }
        return null;
    }
